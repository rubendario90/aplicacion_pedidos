...
// Conexión a la base de datos (asumiendo que $pdo está definido en validate_session.php o login.php)
...
// Ordenar por la columna original 'fecha' de la tabla factura
